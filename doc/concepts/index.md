...
:alt: ardt-core beside the pipeline plane (ardt-pipelines, ardt-ros-pipelines, ardt-doc-pipelines) and the task plane (ardt-ros-tasks, ardt-doc-tasks, ardt-devcontainers); the pipeline plane runs tasks inside containers.
:width: 100%
:align: center
```
